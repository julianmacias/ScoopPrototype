...
// Cross Module References
	SCOOP_API UEnum* Z_Construct_UEnum_Scoop_EMovementState();
	UPackage* Z_Construct_UPackage__Script_Scoop();
	SCOOP_API UScriptStruct* Z_Construct_UScriptStruct_FCharacterDebugSettings();
	SCOOP_API UScriptStruct* Z_Construct_UScriptStruct_FCrouchLerp();
	SCOOP_API UScriptStruct* Z_Construct_UScriptStruct_FCharacterSettings();
	ENGINE_API UClass* Z_Construct_UClass_UPhysicalMaterial_NoRegister();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector2D();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FHitResult();
	SCOOP_API UClass* Z_Construct_UClass_APortalPawn_NoRegister();
	SCOOP_API UClass* Z_Construct_UClass_APortalPawn();
...
// End Cross Module References
	static UEnum* EMovementState_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Scoop_EMovementState, Z_Construct_UPackage__Script_Scoop(), TEXT("EMovementState"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovementState(EMovementState_StaticEnum, TEXT("/Script/Scoop"), TEXT("EMovementState"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Scoop_EMovementState_Hash() { return 4210140296U; }
	UEnum* Z_Construct_UEnum_Scoop_EMovementState()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Scoop();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EMovementState"), 0, Get_Z_Construct_UEnum_Scoop_EMovementState_Hash(), false);
#else
...
class UScriptStruct* FCharacterDebugSettings::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern SCOOP_API uint32 Get_Z_Construct_UScriptStruct_FCharacterDebugSettings_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharacterDebugSettings, Z_Construct_UPackage__Script_Scoop(), TEXT("CharacterDebugSettings"), sizeof(FCharacterDebugSettings), Get_Z_Construct_UScriptStruct_FCharacterDebugSettings_Hash());
	}
	return Singleton;
}
template<> SCOOP_API UScriptStruct* StaticStruct<FCharacterDebugSettings>()
{
	return FCharacterDebugSettings::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FCharacterDebugSettings(FCharacterDebugSettings::StaticStruct, TEXT("/Script/Scoop"), TEXT("CharacterDebugSettings"), false, nullptr, nullptr);
static struct FScriptStruct_Scoop_StaticRegisterNativesFCharacterDebugSettings
{
	FScriptStruct_Scoop_StaticRegisterNativesFCharacterDebugSettings()
	{
...
} ScriptStruct_Scoop_StaticRegisterNativesFCharacterDebugSettings;
	...
	uint32 Get_Z_Construct_UScriptStruct_FCharacterDebugSettings_Hash() { return 2919226534U; }
class UScriptStruct* FCrouchLerp::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern SCOOP_API uint32 Get_Z_Construct_UScriptStruct_FCrouchLerp_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FCrouchLerp, Z_Construct_UPackage__Script_Scoop(), TEXT("CrouchLerp"), sizeof(FCrouchLerp), Get_Z_Construct_UScriptStruct_FCrouchLerp_Hash());
	}
	return Singleton;
}
template<> SCOOP_API UScriptStruct* StaticStruct<FCrouchLerp>()
{
	return FCrouchLerp::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FCrouchLerp(FCrouchLerp::StaticStruct, TEXT("/Script/Scoop"), TEXT("CrouchLerp"), false, nullptr, nullptr);
static struct FScriptStruct_Scoop_StaticRegisterNativesFCrouchLerp
{
	FScriptStruct_Scoop_StaticRegisterNativesFCrouchLerp()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("CrouchLerp")),new UScriptStruct::TCppStructOps<FCrouchLerp>);
	}
} ScriptStruct_Scoop_StaticRegisterNativesFCrouchLerp;
	...
	uint32 Get_Z_Construct_UScriptStruct_FCrouchLerp_Hash() { return 1458674655U; }
class UScriptStruct* FCharacterSettings::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern SCOOP_API uint32 Get_Z_Construct_UScriptStruct_FCharacterSettings_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharacterSettings, Z_Construct_UPackage__Script_Scoop(), TEXT("CharacterSettings"), sizeof(FCharacterSettings), Get_Z_Construct_UScriptStruct_FCharacterSettings_Hash());
	}
	return Singleton;
}
template<> SCOOP_API UScriptStruct* StaticStruct<FCharacterSettings>()
{
	return FCharacterSettings::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FCharacterSettings(FCharacterSettings::StaticStruct, TEXT("/Script/Scoop"), TEXT("CharacterSettings"), false, nullptr, nullptr);
static struct FScriptStruct_Scoop_StaticRegisterNativesFCharacterSettings
{
	FScriptStruct_Scoop_StaticRegisterNativesFCharacterSettings()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("CharacterSettings")),new UScriptStruct::TCppStructOps<FCharacterSettings>);
	}
} ScriptStruct_Scoop_StaticRegisterNativesFCharacterSettings;
	...
	uint32 Get_Z_Construct_UScriptStruct_FCharacterSettings_Hash() { return 2373145104U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APortalPawn_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_APortalPawn_PortalTraceSingleExample, "PortalTraceSingleExample" }, // 2925319887
	...
	IMPLEMENT_CLASS(APortalPawn, 2994630986);
	template<> SCOOP_API UClass* StaticClass<APortalPawn>()
	{
		return APortalPawn::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APortalPawn(Z_Construct_UClass_APortalPawn, &APortalPawn::StaticClass, TEXT("/Script/Scoop"), TEXT("APortalPawn"), false, nullptr, nullptr, nullptr);
