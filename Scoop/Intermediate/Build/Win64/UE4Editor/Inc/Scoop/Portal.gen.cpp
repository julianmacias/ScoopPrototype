...
// Cross Module References
	SCOOP_API UScriptStruct* Z_Construct_UScriptStruct_FPostPhysicsTick();
	UPackage* Z_Construct_UPackage__Script_Scoop();
	ENGINE_API UScriptStruct* Z_Construct_UScriptStruct_FActorTickFunction();
	SCOOP_API UScriptStruct* Z_Construct_UScriptStruct_FTrackedActor();
	SCOOP_API UClass* Z_Construct_UClass_APortal_NoRegister();
	SCOOP_API UClass* Z_Construct_UClass_APortal();
...
class UScriptStruct* FPostPhysicsTick::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern SCOOP_API uint32 Get_Z_Construct_UScriptStruct_FPostPhysicsTick_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FPostPhysicsTick, Z_Construct_UPackage__Script_Scoop(), TEXT("PostPhysicsTick"), sizeof(FPostPhysicsTick), Get_Z_Construct_UScriptStruct_FPostPhysicsTick_Hash());
	}
	return Singleton;
}
template<> SCOOP_API UScriptStruct* StaticStruct<FPostPhysicsTick>()
{
	return FPostPhysicsTick::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FPostPhysicsTick(FPostPhysicsTick::StaticStruct, TEXT("/Script/Scoop"), TEXT("PostPhysicsTick"), false, nullptr, nullptr);
static struct FScriptStruct_Scoop_StaticRegisterNativesFPostPhysicsTick
{
	FScriptStruct_Scoop_StaticRegisterNativesFPostPhysicsTick()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("PostPhysicsTick")),new UScriptStruct::TCppStructOps<FPostPhysicsTick>);
	}
} ScriptStruct_Scoop_StaticRegisterNativesFPostPhysicsTick;
	...
	UScriptStruct* Z_Construct_UScriptStruct_FPostPhysicsTick()
	{
		...
		UPackage* Outer = Z_Construct_UPackage__Script_Scoop();
	...
	uint32 Get_Z_Construct_UScriptStruct_FPostPhysicsTick_Hash() { return 1507891861U; }
class UScriptStruct* FTrackedActor::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern SCOOP_API uint32 Get_Z_Construct_UScriptStruct_FTrackedActor_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FTrackedActor, Z_Construct_UPackage__Script_Scoop(), TEXT("TrackedActor"), sizeof(FTrackedActor), Get_Z_Construct_UScriptStruct_FTrackedActor_Hash());
	}
	return Singleton;
}
template<> SCOOP_API UScriptStruct* StaticStruct<FTrackedActor>()
{
	return FTrackedActor::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FTrackedActor(FTrackedActor::StaticStruct, TEXT("/Script/Scoop"), TEXT("TrackedActor"), false, nullptr, nullptr);
static struct FScriptStruct_Scoop_StaticRegisterNativesFTrackedActor
{
	FScriptStruct_Scoop_StaticRegisterNativesFTrackedActor()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("TrackedActor")),new UScriptStruct::TCppStructOps<FTrackedActor>);
	}
} ScriptStruct_Scoop_StaticRegisterNativesFTrackedActor;
	...
	uint32 Get_Z_Construct_UScriptStruct_FTrackedActor_Hash() { return 2506618500U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_portalChar_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_portalChar;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APortal_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_APortal_ConvertDirectionToTarget, "ConvertDirectionToTarget" }, // 1639945353
		{ &Z_Construct_UFunction_APortal_ConvertLocationToPortal, "ConvertLocationToPortal" }, // 3147621290
		{ &Z_Construct_UFunction_APortal_ConvertRotationToPortal, "ConvertRotationToPortal" }, // 284223192
		{ &Z_Construct_UFunction_APortal_GetDuplicateMap, "GetDuplicateMap" }, // 2264868297
		...
		{ &Z_Construct_UFunction_APortal_IsInfront, "IsInfront" }, // 2684478000
		{ &Z_Construct_UFunction_APortal_LocationInsidePortal, "LocationInsidePortal" }, // 1563289997
		{ &Z_Construct_UFunction_APortal_OnPortalBoxOverlapEnd, "OnPortalBoxOverlapEnd" }, // 3973741402
		{ &Z_Construct_UFunction_APortal_OnPortalBoxOverlapStart, "OnPortalBoxOverlapStart" }, // 2363531109
		{ &Z_Construct_UFunction_APortal_OnPortalMeshOverlapEnd, "OnPortalMeshOverlapEnd" }, // 1616193254
		{ &Z_Construct_UFunction_APortal_OnPortalMeshOverlapStart, "OnPortalMeshOverlapStart" }, // 2769007522
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APortal_Statics::NewProp_portalChar_MetaData[] = {
		{ "Comment", "/* The portal character */" },
		{ "ModuleRelativePath", "Portal.h" },
		{ "ToolTip", "The portal character" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APortal_Statics::NewProp_portalChar = { "portalChar", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APortal, portalChar), Z_Construct_UClass_APortalCharacter_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APortal_Statics::NewProp_portalChar_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APortal_Statics::NewProp_portalChar_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APortal_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APortal_Statics::NewProp_portalChar,
	...
	IMPLEMENT_CLASS(APortal, 3910810337);
	template<> SCOOP_API UClass* StaticClass<APortal>()
	{
		return APortal::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_APortal(Z_Construct_UClass_APortal, &APortal::StaticClass, TEXT("/Script/Scoop"), TEXT("APortal"), false, nullptr, nullptr, nullptr);
